		...
		<header id="home" class="welcome-hero">
			...
			<div id="header-carousel" class="carousel slide carousel-fade" data-ride="carousel">
				<!--/.carousel-indicator -->
				 <ol class="carousel-indicators">
					 <c:forEach begin="0" end="${fn:length(productList)-1}" step="1" var="i">
						 <li data-target="#header-carousel" data-slide-to="${i}" class="${i eq 0 ? 'active' : ''}"><span class="small-circle"></span></li>
					 </c:forEach>
				</ol><!-- /ol-->
				<!--/.carousel-indicator -->
				...
				<div class="carousel-inner" role="listbox">
					...
					<!-- .item -->
					<div class="item ${i.index eq 0 ? 'active' : ''}">
						<div class="single-slide-item slide${i.index+1}">
							<div class="container">
...
<%--											<span class="badge badge-bg-1">2</span>--%>
				            ...
				            <div class="collapse navbar-collapse menu-ui-design" id="navbar-menu">
				                <ul class="nav navbar-nav navbar-center" data-in="fadeInDown" data-out="fadeOutUp">
				                    ...
				                    <li class="scroll"><a href="#feature">category</a></li>
		...
		<section id="feature" class="feature">
			<div class="container">
				...
				<c:forEach items="${productCategory}" var="item">
